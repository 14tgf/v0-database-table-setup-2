...
export async function loginUser(
  ...
  const users = await sql`
    SELECT id, email, password_hash, full_name, phone, kyc_status, account_type, status, wallet_balance, created_at, updated_at
    FROM users
...
/**
 * Get user password hash for login verification
 */
